                ...
                <div className="relative h-full">
                    <div className="flex justify-between items-center h-full">
                        ...
                        <div className="flex space-x-6 items-center">
                            <div className="compaire relative"><Link to={"/compaire"}>
                                <span>
                            ...
                            </Link><span className="w-[18px] h-[18px] rounded-full  absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px] primary-bg-color">{getCompare?.length}</span></div>
                            <div className="favorite relative"><Link to={"/wishlist"}>
                                <span>
                            ...
                            </Link><span className="w-[18px] h-[18px] rounded-full  absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px] primary-bg-color">{getFav?.length}</span></div>
                            <div className="cart-wrapper group relative py-4">
                                <div className="cart relative cursor-pointer"><Link to={"/cart"} >
                                    <span>
                                ...
                                </Link><span className="w-[18px] h-[18px] rounded-full  absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px] primary-bg-color">{getData.cart.length}</span></div>
                                <div className="w-[300px] bg-white border-t-[3px] cart-wrappwer  absolute -right-[45px] top-11 z-50 hidden group-hover:block" style={{ boxShadow: 'rgba(0, 0, 0, 0.14) 0px 15px 50px 0px' }}
                                >
                                    <div className="w-full h-full">
                                            ...
                                            <ul>
                                                {
                                                    getData.cart?.map(product =>
                                                        <CartDataProdCard key={product.id}
                                                            product={product} />
                                                    )
                                                }
                                            </ul>
                                        ...
                                        <div className="product-actions px-4 mb-[30px]">
                                            <div className="total-equation flex justify-between items-center mb-[28px]"><span className="text-[15px] font-500 text-qblack">Subtotal</span><span className="text-[15px] font-500 text-qred ">${subtotal}</span></div>
                                            <div className="product-action-btn">
                                                <Link to={"/cart"}>
                                                    <div className="gray-btn w-full h-[50px] mb-[10px] "><span>View Cart</span></div>
                                                </Link>
