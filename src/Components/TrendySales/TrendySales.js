                            ...
                            <div className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5">
                                <div className="category-card hidden xl:block w-full">
                                    <div className="category-card-wrappwer w-full h-full p-[30px]" >
                                        <div>
                                            <h1 className="text-base font-bold tracking-wide mb-2 ">Mobile &amp; Tablet</h1>
                                            <div className="brands-list mb-[7px] ">
                                                <ul>
                                                    <li><a href="/all-product"><span className="text-sm text-slate-500 hober:text-qBlack border-b border-transparent hover:border-qblack hover:text-qblack capitalize">xioami</span></a></li>
                                                    <li><a href="/all-product"><span className="text-sm text-slate-500 hober:text-qBlack border-b border-transparent hover:border-qblack hover:text-qblack capitalize">apple</span></a></li>
                                                    <li><a href="/all-product"><span className="text-sm text-slate-500 hober:text-qBlack border-b border-transparent hover:border-qblack hover:text-qblack capitalize">google</span></a></li>
                                                    <li><a href="/all-product"><span className="text-sm text-slate-500 hober:text-qBlack border-b border-transparent hover:border-qblack hover:text-qblack capitalize">samsung</span></a></li>
                                                </ul>
                                            </div>
                                            <a href="/">
                                                <div className="flex space-x-2 items-center"><span className="text-qblack font-bold text-sm">Shop Now</span><span><svg width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="2.08984" y="0.636719" width="6.94219" height="1.54271" transform="rotate(45 2.08984 0.636719)" fill="#1D1D1D"></rect><rect x="7" y="5.54492" width="6.94219" height="1.54271" transform="rotate(135 7 5.54492)" fill="#1D1D1D"></rect></svg></span></div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
