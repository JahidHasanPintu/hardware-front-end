            ...
            <div className="section-wrapper w-11/12 mx-auto ">
                <div className="container-x mx-auto">
                    <div className=" section-title flex justify-between items-center mb-5">
                        <div>
                            <h1 className="sm:text-3xl text-xl font-semibold text-qblacktext leading-none">{t('NewArrivals')}</h1>
                        </div>
                        <div>
                            <a href="/all-product">
                    ...
                    <div className="section-content">
                        <div className="products-section w-full text-start" >
                            <div className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-2 xl:gap-[30px] gap-2">
                            {
